...
class LoreCheckinEnvironment(private val project: Project) : CheckinEnvironment {
    ...
    override fun getCheckinOperationName(): String = LoreBundle.message("checkin.operation")
        ...
        LorePaths.groupChanges(changes).forEach { (root, paths) ->
            try {
                ...
                if (push) {
                    ...
                    feedback += LoreBundle.message("checkin.pushed", root.toString())
                }
    ...
    private class PushAfterCommitOption(private val context: CommitContext) : RefreshableOnComponent {
        ...
        private val checkBox = JCheckBox(LoreBundle.message("checkin.push.after.commit"), true)
