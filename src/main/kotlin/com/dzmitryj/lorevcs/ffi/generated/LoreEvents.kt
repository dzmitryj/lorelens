...
import com.dzmitryj.lorevcs.ffi.LoreCopy
...
object LoreEventReader {
    ...
    fun read(event: MemorySegment): LoreEvent {
        ...
        return when (lore_event_t.tag(event)) {
            ...
            214 -> RevisionTreeInfoEvent(id = lore_revision_tree_info_event_data_t.id(payload.asSlice(0L, lore_revision_tree_info_event_data_t.SIZE)), repository = LoreCopy.fixedBytes(lore_partition_t.data(lore_revision_tree_info_event_data_t.repository(payload.asSlice(0L, lore_revision_tree_info_event_data_t.SIZE)))), revision = LoreCopy.fixedBytes(lore_hash_t.data(lore_revision_tree_info_event_data_t.revision(payload.asSlice(0L, lore_revision_tree_info_event_data_t.SIZE)))), creation_timestamp = lore_revision_tree_info_event_data_t.creation_timestamp(payload.asSlice(0L, lore_revision_tree_info_event_data_t.SIZE)), author_identity = LoreCopy.string(lore_revision_tree_info_event_data_t.author_identity(payload.asSlice(0L, lore_revision_tree_info_event_data_t.SIZE))), metadata_key_count = lore_revision_tree_info_event_data_t.metadata_key_count(payload.asSlice(0L, lore_revision_tree_info_event_data_t.SIZE)), error_code = lore_revision_tree_info_event_data_t.error_code(payload.asSlice(0L, lore_revision_tree_info_event_data_t.SIZE)))
