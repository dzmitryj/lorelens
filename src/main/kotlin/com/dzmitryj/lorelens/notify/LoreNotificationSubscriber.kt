package com.dzmitryj.lorelens.notify
...
import com.dzmitryj.lorelens.ffi.generated.NotificationBranchPushedEvent
import com.dzmitryj.lorelens.ffi.generated.NotificationResourceLockedEvent
import com.dzmitryj.lorelens.ffi.generated.NotificationResourceUnlockedEvent
import com.dzmitryj.lorelens.ffi.generated.lore_notification_subscribe_args_t
...
class LoreNotificationSubscriber(private val project: Project) : Disposable {
    ...
    private fun notifyPushed(event: NotificationBranchPushedEvent) {
        NotificationGroupManager.getInstance()
            ...
            .createNotification(
                LoreLensBundle.message("notify.pushed.title"),
                LoreLensBundle.message("notify.pushed.message", event.revision_number, event.user_id),
