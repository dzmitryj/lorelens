...
class PluginRootTest {
    ...
    fun `a non jar url yields no plugin directory`() {
        assertNull(LoreLinker.pluginRootOf("file:/tmp/classes/messages/LoreBundle.properties"))
